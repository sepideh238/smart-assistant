...
{/* آیکن Facebook (دایره خاکستری + لوگو سفید) */}
<svg viewBox="0 0 50 50" className="social-svg" xmlns="http://www.w3.org/2000/svg">
...
{/* آیکن Twitter (دایره خاکستری + لوگو سفید) */}
<svg viewBox="0 0 50 50" className="social-svg" xmlns="http://www.w3.org/2000/svg">
  <circle cx="25" cy="25" r="22" fill="#d9d9d9" />
  <path
    fill="#ffffff"
...
{/* آیکن Instagram (دایره خاکستری + دوربین سفید) */}
<svg viewBox="0 0 50 50" className="social-svg" xmlns="http://www.w3.org/2000/svg">
  <circle cx="25" cy="25" r="22" fill="#d9d9d9" />
  <rect x="16" y="16" width="18" height="18" rx="5" fill="none" stroke="#ffffff" strokeWidth="3" />
  <circle cx="25" cy="25" r="4" fill="#ffffff" />
  <circle cx="32" cy="18" r="2" fill="#ffffff" />
</svg>

{/* آیکن LinkedIn (دایره خاکستری + لوگو سفید) */}
<svg viewBox="0 0 50 50" className="social-svg" xmlns="http://www.w3.org/2000/svg">
  <circle cx="25" cy="25" r="22" fill="#d9d9d9" />
  <rect x="15" y="20" width="4" height="12" fill="#ffffff" />
  <circle cx="17" cy="16" r="2.2" fill="#ffffff" />
  <path
...
{/* آیکن YouTube (دایره خاکستری + پلی سفید) */}
<svg viewBox="0 0 50 50" className="social-svg" xmlns="http://www.w3.org/2000/svg">
  <circle cx="25" cy="25" r="22" fill="#d9d9d9" />
  <path d="M20 18h10c4 0 5 1 5 5v4c0 4-1 5-5 5H20c-4 0-5-1-5-5v-4c0-4 1-5 5-5z" fill="#ffffff" />
  <polygon points="23,20.5 32,25 23,29.5" fill="#ef4056" />
</svg>
